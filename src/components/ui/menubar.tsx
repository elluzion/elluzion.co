...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-10 items-center space-x-1 rounded-lg border p-1",
      className
    )}
    {...props}
  />
...
const MenubarShortInfo = ({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-xs font-mono text-muted-foreground",
        className
      )}
      {...props}
    />
...
MenubarShortInfo.displayname = "MenubarShortInfo";
